...
function showMaintenance(){  
    $.ajax({
        url:"./adminView/viewMaintenance.php",
        method:"post",
        data:{record:1},
        success:function(data){
            $('.allContent-section').html(data);
...
function showQualityControl(){
    $.ajax({
        url:"./adminView/viewQualityControl.php",
        method:"post",
        data:{record:1},
        success:function(data){
            $('.allContent-section').html(data);
...
function addItems(){
    ...
    var p_bom=$('#p_bom').val(); // Get the value of BOM link
    ...
    fd.append('p_bom', p_bom); // Append BOM link to FormData
    fd.append('file', file);
...
function showProductDetails(id) {  
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#productDetailsModal .modal-body').html(data);
            // Show the modal
